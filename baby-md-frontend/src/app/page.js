...
export default function Home() {
  ...
  <p>
    ...
    From midnight fevers to milestone check-ups, these stats reflect a story of care that goes beyond treatment — it’s about peace of mind and trust.
  </p>
</div>
       ...
       <div className="relative w-80 h-[300px] md:mb-12">
        ...
        <div className="bg-[#ebf9be64] rounded-3xl p-8 md:p-12 mb-8 md:mb-12">
          <h2 className=" text-2xl md:text-3xl font-bold leading-tight mb-4">
            Every child is a miracle — <br /> a unique story <span className="text-[#4B3A8F]">we’re here <br />to care for</span> 
          </h2>
 ...
 <div className="w-full bg-[#F4DF76] rounded-xl mb-4">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700">
                Our experts take time to listen, support, and reassure, because every decision matters.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700">
                No rushed check-ups, we track milestones, coordinate with specialists, and address every concern thoughtfully.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700">
                From playful spaces to a team that knows your family by name, we make healthcare warm, welcoming, and child-first.
              </p>
            </div>
          </div>
        </div>
  ...
  <h2 className="text-2xl md:text-3xl font-bold leading-tight mb-4">
    We’re here for the <span className="text-[#4B3A8F]">giggles, sniffles, and everything in <span className="italic font-light"> between!</span></span> 
  </h2>
  <p className="">
    Some days you’re celebrating first steps. <br /> Other days, you’re worried about a fever at 2 AM. We are here for it all. Whether it’s a quick check-up, a vaccine visit, or something that needs a deeper look, we offer the kind of care that listens, explains, and walks the path with you.
  </p>
      ...
      <div className="rounded-t-2xl  bg-white overflow-hidden">
        ...
        <div className="p-4 bg-[#E6D6FA]">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-black text-lg font-bold">General Consultations</p>
            </div>
          </div>
        </div>

        {/* Vaccinations */}
        <div className="p-4 bg-[#D6FAD6]">
          <div className="flex items-start gap-4">
            <div className="relative w-14 h-14 flex-shrink-0">
              <Image
                src={IconBackground}
        ...
        <div className="p-4 bg-[#FAF1D6]">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-black text-lg font-bold">Super Specialist Consultations</p>
            </div>
          </div>
        </div>

        {/* Developmental Assessments and Therapies */}
        <div className="p-4 bg-[#D6F4FA]">
          <div className="flex items-start gap-4">
            <div className="relative w-14 h-14 flex-shrink-0">
              <Image
                src={IconBackground}
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                Our developmental pediatricians and certified therapists go beyond symptoms to create personalized plans that address your little one&apos;s unique needs — from speech delays to behavioral challenges.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="  p-8 pt-0 md:p-12 mt-8  md:mb-12 ">
          <h2 className="text-2xl md:text-3xl font-bold leading-tight mb-4">
            More than symptoms, <br />we see the <span className="text-[#4B3A8F] ">bigger </span> <br /><span className="text-[#4B3A8F] italic font-light">picture</span>
          </h2>
          <p >
            Because every child is a miracle, and every concern deserves real attention. Whether it’s just a feeling, your tiny tot’s in a fever, a delay, or just a feeling, we’re here with expert eyes, kind hearts, and real answers.
          </p>
          <div className="grid grid-cols-2 mt-4 sm:grid-cols-3 gap-4">
            <button className="bg-[#FAF1D6] text-[#4B3A8F] font-semibold py-2 px-4 rounded-full hover:bg-[#F6E8C3] transition-all duration-300">
              Lorem ipsum
            </button>
            <button className="bg-[#FAF1D6] text-[#4B3A8F] font-semibold py-2 px-4 rounded-full hover:bg-[#F6E8C3] transition-all duration-300">
              Lorem ipsum
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 mb-8 md:mb-12 shadow-md">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              You&apos;re the expert when it comes to your child — but sometimes, it helps to have an extra pair of professional eyes. Our free, online{" "}
              <span className="font-semibold">milestone assessment tool</span> lets you easily track their development, from physical growth to behavioral needs. In just a few simple steps, you&apos;ll get the clarity you need to understand where they stand and feel confident in their progress.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#FFF5F5] rounded-3xl p-9 md:p-12 mb-8 md:mb-12">
          <div className="max-w-2xl">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              All of this, <span className="text-[#4B3A8F]">just</span><br />
              <span className="text-[#4B3A8F]">around</span>{" "}
              <span className="text-[#4B3A8F] italic">the corner</span>
            </h2>
            <p className=" text-lg leading-relaxed mb-6">
              Late-night worries or last-minute scrambles shouldn&apos;t mean a long drive or endless queues. We&apos;re all about making care easy and accessible, so you can feel confident even on your toughest days. That&apos;s why our clinics are right in your neighborhood — cozy, colourful, and designed with your little one in mind.
            </p>
...
<div className="relative max-w-md mx-auto rounded-2xl overflow-hidden bg-white p-4">
  ...
  <div className="relative text-center mb-4 px-8">
    ...
    <p className="text-sm text-gray-600 mb-2">
      99, 11<sup>th</sup> Main Rd, Sector 5, Sector 6,<br />
      HSR Layout, Bengaluru, Karnataka 560068
    </p>
    <p className="text-sm text-gray-600">
      Mon-Sat: 8AM - 1:30PM | 4PM - 8:30PM<br />
      Sundays: 9AM - 12PM
    </p>
...
<div className="bg-[#DFF1FF] rounded-t-3xl p-6 md:p-8 text-[#4B3A8F] relative">
  ...
  <h2 className="text-xl md:text-2xl font-bold mb-2">
    Don&apos;t just <span className="text-purple-600">take</span><br />
    <span className="text-purple-600 italic font-medium">our word</span> for it
  </h2>
  ...
  <div className="bg-white rounded-lg p-4 md:p-5 mt-4 shadow-sm relative">
    <p className="text-sm leading-relaxed text-gray-800">
      &quot;We had a wonderful consultation with Dr Shivanga Bora at BabyMD HSR 
      Layout, for my son&apos;s wheezing issue. She was incredibly patient, listened to all our 
      concerns, and provided a clear effective treatment plan. Her friendly approach and 
      expertise made us feel reassured and confident in the care my son received. 
    ...
    <div className="mt-4 flex items-center gap-3">
      ...
      <div className="text-xs">
        ...
        <p className="text-[#4B3A8F] text-xs">
          BabyMD HSR Layout
        </p>
      </div>
    </div>
  ...
  {/* CTA Button - Positioned under author details as in the reference image */}
  <div className="mt-0">
...
<div className="bg-[#F8F6FB] bg-opacity-80 rounded-t-3xl p-6 space-y-4">
  ...
  <div className="text-[#6A58AD]">
    ...
    How about some{" "} <br/>
      <span className="italic font-medium text-[#6A58AD]">parenting tips</span>,{" "}
      <span className="text-black font-normal">so you can skip <br />the panic scroll?</span>
    </h2>
    <p className="text-sm text-black mt-2 leading-tight">
      Ever wished parenting came with a guidebook? From picky eating to tantrums,
      we know you&apos;ve got questions. Join our expert-led webinars to get practical tips and
      expert answers to feel confident and supported in your parenting journey.
    </p>
  </div>
      ...
      <div className="relative">
        ...
        <div className="relative h-48 w-80">
          ...
          <div className="absolute top-0 right-2 bg-[#3810c8] text-white text-xs p-1 rounded-md font-bold text-center w-8 ">
            <span className="text-base">28</span><br />
        ...
        <div className="bg-[#FDF8DB] p-6 rounded-t-3xl space-y-8 ">
          ...
          <div className="text-[#231F20]">
            <h2 className="text-xl font-semibold">
              Parenting
              <span className="italic font-light text-[#4B3A8F]"> unplugged!</span>
             
            </h2>
            <p className="text-sm mt-2 text-[#231F20]">
              Juggling work, family, and endless advice on parenting? We’ve got you covered.
              Delve into our expert insights, practical tips, and the latest updates — curated exclusively for you.
            </p>
          </div>
          ...
          <div className="bg-[#FDF8DB] rounded-xl p-2 w-full max-w-xs">
           ...
           <div className="relative right-8.5 w-100 h-[190px] md:mb-12">
            ...
            {/* Category & Title */}
            <div className="mt-3 ">
              <p className="text-[10px] font-bold text-[#EB5A44] uppercase">Case Study</p>
  ...
  {/* Heading */}
  <div style={{ fontFamily: 'Baloo 2, sans-serif', fontSize: '28px', lineHeight: '30px' }}>
    <h2 className="text-lg font-bold leading-snug">
      Because <span className="text-white">Parenting</span><br />
      Shouldn’t Cost A <span className="italic font-normal"><br />Fortune</span>
    </h2>
    <p className="text-sm mt-2" style={{ fontFamily: 'Baloo 2, sans-serif', fontSize: '16px', lineHeight: '22px' }}>
  ...
  <div className="flex flex-row gap-3">
    {/* Gold Plan */}
    <div className="bg-white text-[#231F20] p-4 rounded-xl space-y-2 shadow w-full"
      style={{ width: '138px', height: '306px', borderTopLeftRadius: '20px', borderTopRightRadius: '20px', borderBottomRightRadius: '20px', borderBottomLeftRadius: '15px' }}>
    ...
    {/* Platinum Plan */}
    <div className="bg-white text-[#231F20] p-4 rounded-xl space-y-2 border-2 border-[#6C40B5] shadow w-full"
      style={{ width: '138px', height: '306px', borderTopLeftRadius: '20px', borderTopRightRadius: '20px', borderBottomRightRadius: '20px', borderBottomLeftRadius: '15px' }}>
  ...
  {/* CTA Button */}
  <div className="flex justify-center  relative  z-15">
    <button className="bg-[#4B3A8F] text-white text-sm font-semibold py-3 px-6 rounded-full flex items-center gap-2 hover:scale-105 transition">
  ...
  {/* Overlapping Images */}
  <div className="absolute bottom-0 right-0 w-[160px] h-[160px] z-0">
    <Image
      src={Premiumlayer}
    ...
    />
  {/* </div>
  <div className="absolute bottom-0 right-0 w-[160px] h-[160px] z-10"> */}
    <Image
      src={PremiumlayerImg}
    ...
    />
        ...
        <div className="bg-[#6C40B5] text-white rounded-2xl p-5 max-w-xs mx-auto space-y-4">
          {/* Heading */}
          <h2 className="text-lg font-bold leading-snug mt"
            style={{
          ...
          <p className="text-sm leading-snug"
            style={{fontSize: '16px', lineHeight: '22px', letterSpacing: '0%', verticalAlign: 'middle'}}>
            Babies don’t come with instructions, but we do. Whether it’s a routine check-up, a fever that won’t quit, or just a little peace of mind — just pick a time, choose a clinic, and we’ll handle the rest.
          </p>
        ...
        >
          ...
          <p
            ...
            style={{
              fontFamily: 'inherit',
              fontSize: '16px', // Retaining default font for consistency with other paragraphs,
              lineHeight: '22px',
              verticalAlign: 'middle',
            }}
          >
            Got questions about midnight fevers, first foods, routine vaccines, tricky rashes, or curious growth spurts? We’re here to guide you through every question — no judgment, just answers you can rely on.
          </p>
          <div className="space-y-4">
            {/* Question 1 */}
            <details className="group">
              <summary className="flex justify-between items-center p-4 bg-[#E1F5FF] rounded-xl shadow-sm cursor-pointer">
                <span className="text-[#4B3A8F] text-lg font-medium" style={{fontSize: '14px', lineHeight: '18px'}}>
                  What is treatment therapy for kids?
                </span>
                <svg className="w-5 h-5 text-[#4B3A8F] transform transition-transform group-open:rotate-180"
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
              <div className="mt-0.5 p-4 bg-[#FAF1D6] rounded-xl">
                <p className="text-[#4B3A8F] text-sm leading-relaxed" style={{fontSize: '14px', lineHeight: '18px'}}>
                  No, these therapies are non-invasive and absolutely safe for your child.
                </p>
              </div>
            </details>
